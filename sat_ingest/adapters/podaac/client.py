...
class PodaacAdapter:
    ...
    def search(self, params) -> Iterable[SearchResult]:
        collections = params.collections or ["jason-3-altimetry", "sentinel-6-altimetry", "swot", "smap"]
    ...
    def download(self, item: SearchResult, asset_keys: Optional[List[str]] = None,
        ...
        keys = asset_keys or ["measurement", "quality", "ancillary"]
