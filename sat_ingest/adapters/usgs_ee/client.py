...
class UsgsEarthExplorerAdapter:
    def __init__(self, **kwargs: Any):
        # os.environ.get("USGS_USERNAME"), os.environ.get("USGS_PASSWORD")
    ...
    def search(self, params) -> Iterable[SearchResult]:
        # Common Landsat collections if not supplied
        collections = params.collections or ["landsat-8-l2", "landsat-9-l2", "landsat-7", "landsat-5"]
